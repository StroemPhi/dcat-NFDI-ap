# Contributing to dcat-NFDI-ap

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
dcat-NFDI-ap. These guidelines are not strict rules.
...
The dcat-NFDI-ap team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the dcat-NFDI-ap technical leads
...
[issues]: https://github.com/StroemPhi/dcat-NFDI-ap/issues/
[pulls]: https://github.com/StroemPhi/dcat-NFDI-ap/pulls/
